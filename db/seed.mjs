...
import { taskOfDestiny } from './content/task-of-destiny.mjs';
...
const posts = [taskOfDestiny, howSkillionWorks, habitData2026, gamifyYourLife, skillionVsHabitica, bestHabitApps, whyHabitsFail, ...legacyPosts];
